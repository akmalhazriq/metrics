  ...
  return (
    <div className="mx-auto max-w-[720px] px-4 py-8 sm:px-6">
      ...
      <p className="text-muted-foreground mt-1 text-sm">
        Metric is an AI native BI tool built on the Superset core, with a denser, tool like feel.
      </p>
      <div className="border-border bg-card mt-6 rounded-lg border p-5">
        <dl className="grid gap-3 text-sm">
          <div className="flex justify-between gap-4">
            <dt className="text-muted-foreground">App</dt>
            <dd className="font-medium">{info?.name ?? "Metric BI"}</dd>
          </div>
          <div className="flex justify-between gap-4">
          ...
          <div className="flex justify-between gap-4">
            ...
            <dd className="font-medium">{info?.license ?? "MIT"}</dd>
          </div>
          <div className="flex justify-between gap-4">
